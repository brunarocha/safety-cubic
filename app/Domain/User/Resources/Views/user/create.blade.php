...
<head>
    ...
    <title>Register &mdash; {{\Config::get('app.name')}}</title>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{asset('themes/stisla/modules/jquery-selectric/selectric.css')}}">
...
<!-- JS Libraies -->
<script src="{{asset('themes/stisla/modules/jquery-pwstrength/jquery.pwstrength.min.js')}}"></script>
<script src="{{asset('themes/stisla/modules/jquery-selectric/jquery.selectric.min.js')}}"></script>

<!-- Page Specific JS File -->
<script src="{{asset('themes/stisla/js/page/auth-register.js')}}"></script>
