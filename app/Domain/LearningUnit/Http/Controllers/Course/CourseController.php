 ...
 * @date: 21/10/2019
 */
namespace App\Domain\LearningUnit\Http\Controllers\Course;
 ...
 * @package App\Domain\LearningUnit\Http\Controllers\Course
 */
class CourseController extends Controller {
    ...
    public function show($id)
    {
        ...
        return view('learning-unit::course.student.index')->with(['course' => $course]);
    }
