 ...
 * @date: 21/10/2019
 */
namespace App\Domain\LearningUnit\Http\Controllers\Student\Training\Material;
 ...
 * @package App\Domain\LearningUnit\Http\Controllers\Student\Training\Material
 */
class MaterialController extends Controller {
    ...
    public function index($id)
    {
        ...
        return view('learning-unit::student.training.material.index')->with([
            'training' => $training
        ]);
    }
